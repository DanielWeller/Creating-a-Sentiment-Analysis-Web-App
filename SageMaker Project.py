...
# **Answer:** The method  applies the review_to_words method to each of the reviews in the training and testing datasets. It caches the results. This is because performing this processing step can take a long time. 
...
# **Answer:** `convert_and_pad_data` method is used to pass the same number of words to the neural network. 
#             `preprocess_data` is performed, to link each review to the `review_words` method. All the output is saved to a file             and can be loaded quickly, when we would run the notebook for a second time. 
...
# **Answer:** ![hate.png](attachment:hate.png) ![love.PNG](attachment:love.PNG)
